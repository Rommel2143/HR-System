...
Public Class print_memo_rpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HR_System.print_memo_rpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedprint_memo_rpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As print_memo_rpt = New print_memo_rpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
